...
ActiveRecord::Schema.define(version: 2021_07_11_103003) do
  ...
  create_table "authen_discords", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "email"
    t.string "provider"
    ...
    t.index ["user_id"], name: "index_authen_discords_on_user_id"
  end
  ...
  create_table "discords", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  add_foreign_key "authen_discords", "users"
